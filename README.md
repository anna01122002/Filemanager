...
Изначально, я надеялась что обычное подключение библиотеки Pytest не сотавит труда. Но я ошиблась. Сама библиотека подключалась без ошибок, но вот выполения как ожидалось не было.
